USE [master];
If Exists (Select Name from SysDatabases Where Name = 'DWAdventureWorksLT2014v1')
  Begin
   Alter database DWAdventureWorksLT2014v1 set single_user with rollback immediate;
   Drop database DWAdventureWorksLT2014v1;
  End
go
CREATE DATABASE DWAdventureWorksLT2014v1;
go
